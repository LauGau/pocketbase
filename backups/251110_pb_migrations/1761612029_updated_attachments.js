...
migrate((app) => {
  ...
  unmarshal({
    "createRule": "@request.auth.id != \"\" && @request.body.pinCollection.collectionMembers_via_pinCollection.user ?~ @request.auth.id && @request.body.pinCollection.collectionMembers_via_pinCollection.status ?= \"approved\""
  }, collection)
